...
class TrendFollowing(Strategy):
    def __init__(self, data: DataFrame, ma_windows: List[int], rsi_window: int, macd_fast_window: int, macd_slow_window: int, macd_signal_window: int) -> None:
        ...
        self._handler = RsiHandler(self._handler)
